<template>
  <div class="chat-world">
    ...
    <div :class="log.dir == 0 ? 'right': 'left'">
      <img v-if="log.dir==0" class="small-avatar" :src="me.avatar" @click.stop="head_cb($event, log)">
      <div v-else @click.stop="head_cb($event, log)">{{short_id(log)}}</div>
